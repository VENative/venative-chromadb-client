...
public interface ICollectionClient
{
    ...
    /// <param name="metadatas">The metadata to associate with the embeddings. When querying, you can filter on this metadata. Optional.</param>
    /// <param name="documents">The documents to associate with the embeddings. Optional.</param>
    Task AddAsync(IEnumerable<string>? ids = null, IEnumerable<IEnumerable<float>>? embeddings = null, IEnumerable<IDictionary<string, object>>? metadatas = null, IEnumerable<string>? documents = null, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="metadatas">The metadata to associate with the embeddings. When querying, you can filter on this metadata. Optional.</param>
    /// <param name="documents">The documents to associate with the embeddings. Optional.</param>
    Task UpdateAsync(IEnumerable<string>? ids = null, IEnumerable<IEnumerable<float>>? embeddings = null, IEnumerable<IDictionary<string, object>>? metadatas = null, IEnumerable<string>? documents = null, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="metadatas">The metadata to associate with the embeddings. When querying, you can filter on this metadata. Optional.</param>
    /// <param name="documents">The documents to associate with the embeddings. Optional.</param>
    Task UpsertAsync(IEnumerable<string>? ids = null, IEnumerable<IEnumerable<float>>? embeddings = null, IEnumerable<IDictionary<string, object>>? metadatas = null, IEnumerable<string>? documents = null, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="include">A list of what to include in the results. Can contain "embeddings", "metadatas", "documents". Ids are always included. Defaults to ["metadatas", "documents"]. Optional.</param>
    /// <returns>A GetResult object containing the results.</returns>
    Task<GetResult> GetAsync(IEnumerable<string>? ids = null, IDictionary<string, object>? where = null, int? limit = null, int? offset = null, IDictionary<string, object>? whereDocument = null, IEnumerable<string>? include = null, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="where">A Where type dict used to filter the delection by. E.g. {"color" : "red", "price": 4.20}. Optional.</param>
    /// <param name="whereDocument">A WhereDocument type dict used to filter the deletion by the document content. E.g. {$contains: {"text": "hello"}}. Optional.</param>
    Task DeleteAsync(IEnumerable<string>? ids = null, IDictionary<string, object>? where = null, IDictionary<string, object>? whereDocument = null, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="include">A list of what to include in the results. Can contain "embeddings", "metadatas", "documents", "distances". Ids are always included. Defaults to ["metadatas", "documents", "distances"]. Optional.</param>
    /// <returns> QueryResult object containing the results.</returns>
    Task<QueryResult> QueryAsync(IDictionary<string, object>? where = null, IDictionary<string, object>? whereDocument = null, IEnumerable<IEnumerable<float>>? queryEmbeddings = null, IEnumerable<string>? queryTexts = null, int numberOfResults = 10, IEnumerable<string>? include = null, CancellationToken cancellationToken = default);
}
